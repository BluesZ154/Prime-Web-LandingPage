...
const Contact = () => {
   ...
   return (
      <div className="mx-5 lg:mx-25 mb-20">
         ...
         <div className="flex flex-col lg:flex-row gap-10">
               ...
               <div className="shadow-xl rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                     ...
                     <input
                        ...
                        className="shadow px-2.5 py-2 shadow-blue-300
                  ...
                  <div className="mt-5">
                     <textarea
                        ...
                        className="w-full lg:w-112 h-23 shadow px-2.5 py-2 shadow-blue-300
                           transition-all duration-300 ease-out
                  ...
                  <button
                     className={`
                        ...
                        w-full lg:w-113 mt-3 transition-all duration-300
            ...
            <div className="shadow-xl rounded-xl p-6 h-auto lg:h-52">
               <div>
                  <div className="flex border-b border-neutral-600/30">
                     ...
                     <div className="ml-5">
                        <p className="text-xl mb-1 mt-1">
                           Free Consultation
                        </p>

                        <p className="text-sm text-neutral-500 mt-2 mb-5">
                           Diskusikan kebutuhan proyek Anda bersama tim kami secara gratis
                        </p>
                     </div>
               ...
               <a
                  href="mailto:alihuang154@gmail.com"
                  className="inline-flex gap-2 bg-blue-600 text-white rounded-md text-center p-2 w-full lg:w-45 mt-4 pl-3 justify-center items-center
                     transition-all duration-300 ease-out
               ...
               <a
                  ...
                  className="inline-flex gap-3 bg-white text-blue-600 rounded-md text-center p-2 w-full lg:w-45 mt-4 pl-3 border-2 items-center justify-center
                     transition-all duration-300 ease-out
