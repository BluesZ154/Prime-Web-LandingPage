...
const Portofolio = () => {
   ...
   return (
      <section>
         <div className="mb-15 py-12 px-5 sm:px-8 lg:px-20">
            <p className="uppercase text-blue-600 font-bold text-center">
               OUR PORTOFOLIO
            </p>

            <h4 className="text-3xl font-bold mt-4 mb-10 text-center">
               Some of Our Work
            </h4>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">

               <div className="shadow-xl bg-white rounded-lg transition-all duration-300 ease-out
                  hover:-translate-y-1
               ...
               ">
                  <img
                     src={porto1}
                     alt="Your browser do not support the photo tag."
                  ...
                  <p className="text-neutral-400 text-sm pl-4 mb-3">
                     Landing Page
                  </p>
               ...
               {portofolioItems.map((item, index) => (
                  <div
                     key={index}
                     className="shadow-xl bg-white rounded-lg transition-all duration-300 ease-out
                        hover:-translate-y-1
                        hover:shadow-xl hover:shadow-blue-300/30
